...
Please put [IN_SILICO_LIBRARY.db](https://zenodo.org/record/7293922/files/IN_SILICO_LIBRARY.db)  , [references_index.bin](https://zenodo.org/record/7293922/files/references_index.bin)  and [references_word2vec.model](https://zenodo.org/record/7293922/files/references_word2vec.model)   into **data**  directory.
